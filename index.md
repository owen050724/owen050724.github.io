...
<main class="portfolio-page is-loading">
  <header class="hero">
    ...
    <nav class="profile-links reveal" aria-label="Profile links">
      ...
      <a href="https://discord.com/users/495616210835079178" aria-label="Discord: 연어">
        <svg viewBox="0 0 16 16" aria-hidden="true">
      ...
      <a href="https://www.instagram.com/dus_oh24/" aria-label="Instagram: dus_oh24">
        <svg viewBox="0 0 16 16" aria-hidden="true">
...
<section class="notice reveal">
  ...
  <div class="public-summary-grid">
    ...
    <div>
      ...
      <span>19 open-source product and bug bounty workspaces</span>
    </div>
    <div>
