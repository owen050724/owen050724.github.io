...
<main class="portfolio-page is-loading">
  <header class="hero">
    ...
    <nav class="profile-links reveal" aria-label="Profile links">
      <a href="https://github.com/owen050724" aria-label="GitHub: owen050724">
      ...
      <a href="https://discord.com/users/dusdh" aria-label="Discord: dusdh">
        <svg viewBox="0 0 16 16" aria-hidden="true">
      ...
      <a href="https://www.instagram.com/bss_yop05/" aria-label="Instagram: bss_yop05">
        <svg viewBox="0 0 16 16" aria-hidden="true">
      ...
      <a href="https://www.linkedin.com/in/yeonoh-park-11410b374/" aria-label="LinkedIn: Yeonoh Park">
        <svg viewBox="0 0 16 16" aria-hidden="true">
  ...
  <div class="report-group">
    <h3>CVE / Accepted Reports</h3>
    <p>Vendor-accepted work is listed here only when public disclosure is safe.</p>
  </div>

    <div class="accepted-report">
      <div>
        <p class="accepted-report-code">CVE-2026-59210 · Dify · Accepted / Fixed · Reserved</p>
        <h3>Accepted workspace authorization report</h3>
        <p>Reported 2026. 5. 26. · Fixed by vendor · Public advisory details withheld until publication.</p>
      </div>
