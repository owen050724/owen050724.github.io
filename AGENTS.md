...
- 10 vendor-confirmed outcomes
- 3 CVE identifiers
- 1 GitHub Security Advisory
- 40 researched products/workspaces
- 1 conference paper award on the homepage outcome strip

The ten outcomes are five identified representative findings plus five anonymous coordinated outcomes. Current representative wording must remain conservative:
